...
public class ContactServiceTest {
	...
	void setUp() {
		contactId = "8675309";
		firstNameTest = "Steve";
		lastNameTest = "Rodgers";
		phoneNumberTest = "2813308004";
		addressTest = "124 Conch street, In A Pineapple, Under The Sea";
		tooLongContactId = "112233445566778899";
		tooLongFirstName = "Hubert Blaine Wolfeschlegelsteinhausenbergerdorff Sr.";
		tooLongLastName = "-archibold astronaut";
		tooLongPhoneNumber = "88812341234";
		tooShortPhoneNumber = "3456789";
		tooLongAddress = "191-103 Integer Rd.\r\n" + 
